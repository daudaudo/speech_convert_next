...
const Feature = () => {
	...
	return (
		<section className="flex flex-col gap-2 w-full">
			<div className="w-full font-bold text-xl text-gray-700 dark:text-gray-200">{t("feature")}</div>
			<Carousel
				loop
				autoplay
				prevArrow={({}) => null}
				...
				className="relative h-auto min-h-96 bg-gray-200 dark:bg-gray-800 md:rounded-lg"
			>
