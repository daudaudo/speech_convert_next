...
const HomePage = () => {
	return (
		<div className="w-full h-full bg-gradient-primary inline-flex flex-col items-center">
			...
			<Carousel
				...
				className="max-w-screen-xl bg-gray-200 dark:bg-gray-800 md:rounded-lg md:m-4"
			>
				<div className="px-16 py-2 flex flex-col gap-8 h-full justify-center">
					...
					<div className="inline-flex">
						...
						<audio controls src={"/demo/speech-output.mp3"} className="flex-1" />
					</div>
