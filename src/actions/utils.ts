...
const callApi = async (url: string, method: RequestMethod, body: object | undefined) => {
...
export const callApiAction = async (url: string, method: RequestMethod, body: object | undefined) => {
